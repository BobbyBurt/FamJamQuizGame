...
export default class AnswerPrefab extends Phaser.GameObjects.Container {
  constructor(scene: Phaser.Scene, x?: number, y?: number) {
    ...
    // blueLeftInactive
    const blueLeftInactive = scene.add.image(
      -61,
      1,
    ...
    // blueDownInactive
    const blueDownInactive = scene.add.image(
      -18,
      40,
      "arrow-button-blue-inactive"
    );
    ...
    // blueUpInactive
    const blueUpInactive = scene.add.image(
      -22,
      -40,
      "arrow-button-blue-inactive"
    );
    ...
    const orangeCentreinactive = scene.add.image(
      20,
      0,
    ...
    // orangeUpActive
    const orangeUpActive = scene.add.image(
      18,
      -41,
    ...
    // orangeUpInactive
    const orangeUpInactive = scene.add.image(
      18,
      -41,
    ...
    // orangeDownActive
    const orangeDownActive = scene.add.image(
      22,
      39,
      "arrow-button-orange-active"
    );
    ...
    // orangeDownInactive
    const orangeDownInactive = scene.add.image(
      22,
      39,
      "arrow-button-orange-inactive"
    );
    ...
    // orangeRightActive
    const orangeRightActive = scene.add.image(
      61,
      -1,
      "arrow-button-orange-active"
    );
    ...
    // orangeRightInactive
    const orangeRightInactive = scene.add.image(
      61,
      -1,
      "arrow-button-orange-inactive"
    );
