...
export default class Game extends Phaser.Scene {
	...
	editorCreate(): void {
		...
		// inputFeedback
		const inputFeedback = this.add.container(1311, 514);
		inputFeedback.scaleX = 0.642086873500129;
		inputFeedback.scaleY = 0.642086873500129;
		...
		this.add.image(257, 105, "FamJam-logo-simplified");
